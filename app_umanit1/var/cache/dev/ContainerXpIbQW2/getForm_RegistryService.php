...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Form\\ActivitesType' => ['privates', 'App\\Form\\ActivitesType', 'getActivitesTypeService', true],
            'App\\Form\\BilanCompetencesType' => ['privates', 'App\\Form\\BilanCompetencesType', 'getBilanCompetencesTypeService', true],
            'App\\Form\\EvaluationObjectifsType' => ['privates', 'App\\Form\\EvaluationObjectifsType', 'getEvaluationObjectifsTypeService', true],
            'App\\Form\\FormationsSouhaiteesType' => ['privates', 'App\\Form\\FormationsSouhaiteesType', 'getFormationsSouhaiteesTypeService', true],
            'App\\Form\\FormationsSuivieType' => ['privates', 'App\\Form\\FormationsSuivieType', 'getFormationsSuivieTypeService', true],
            'App\\Form\\FormulaireProgressionType' => ['privates', 'App\\Form\\FormulaireProgressionType', 'getFormulaireProgressionTypeService', true],
            'App\\Form\\ObjectifDefinitionType' => ['privates', 'App\\Form\\ObjectifDefinitionType', 'getObjectifDefinitionTypeService', true],
            ...
            'App\\Form\\ActivitesType' => '?',
            'App\\Form\\BilanCompetencesType' => '?',
            'App\\Form\\EvaluationObjectifsType' => '?',
            'App\\Form\\FormationsSouhaiteesType' => '?',
            'App\\Form\\FormationsSuivieType' => '?',
            'App\\Form\\FormulaireProgressionType' => '?',
            'App\\Form\\ObjectifDefinitionType' => '?',
            'App\\Form\\UserType' => '?',
