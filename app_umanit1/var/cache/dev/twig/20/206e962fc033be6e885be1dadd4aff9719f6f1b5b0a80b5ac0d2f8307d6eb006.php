...
class __TwigTemplate_03db46b52cd051d86326435d0154f0660913c9012ed8bb13057eec98d03d21e8 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("<form class=\"d-inline\" method=\"post\" action=\"{{ path('user_delete', {'id': user.id}) }}\" onsubmit=\"return confirm('Êtes-vous sûr de vouloir supprimer cet utilisateur ?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ user.id) }}\">
    <button class=\"btn\">Supprimer</button>
</form>
", "user/_delete_form.html.twig", "/home/superadmin/Documents/Projet WEB/umanit/app_umanit1/templates/user/_delete_form.html.twig");
    }
}
